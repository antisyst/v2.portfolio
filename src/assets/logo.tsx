...
export default function MainLogo() {
    ...
    return(
        <motion.svg  className="item Logj4t_45" width={138} height="71.8" viewBox="0 0 138 71.8" xmlns="http://www.w3.org/2000/svg"><motion.g id="svgGroup" strokeLinecap="round" fillRule="evenodd" fontSize="9pt" stroke="#ffffff" strokeWidth="0.25mm" fill="#ffffff" style={{stroke: '#ffffff', strokeWidth: '0.25mm', fill: '#ffffff'}} ><motion.path  variants={icon}
        initial="hidden"
        animate="visible"
        transition={{
